...
用户要求总结所有代码文件并生成新的README.md文档。我需要先查看主要的代码文件来了解项目的完整功能和架构，然后生成一个专业的GitHub风格的README文档。
...
filePath: e:\OneDrive\CS\AI\python\UAV_USV_RL_V6\src\env\config.py
e:\OneDrive\CS\AI\python\UAV_USV_RL_V6\scripts\train.py
e:\OneDrive\CS\AI\python\UAV_USV_RL_V6\src\agents\agent.py
          
继续查看核心模块文件以了解完整的项目架构。
...
filePath: e:\OneDrive\CS\AI\python\UAV_USV_RL_V6\src\env\world.py
e:\OneDrive\CS\AI\python\UAV_USV_RL_V6\src\ppo\model.py
e:\OneDrive\CS\AI\python\UAV_USV_RL_V6\src\ppo\ppo.py
...
filePath: e:\OneDrive\CS\AI\python\UAV_USV_RL_V6\src\utils\trajectory_manager.py
e:\OneDrive\CS\AI\python\UAV_USV_RL_V6\src\ppo\obsDataProcess.py
e:\OneDrive\CS\AI\python\UAV_USV_RL_V6\scripts\visualize.html
